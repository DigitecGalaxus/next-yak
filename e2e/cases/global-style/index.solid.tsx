import { globalStyle, keyframes, styled } from "@yak/solid";
...
// Consumes a CSS custom property declared in globalStyle on :root
const WidthConsumer = styled.div`
  width: var(--global-style-width);
  height: 10px;
`;
