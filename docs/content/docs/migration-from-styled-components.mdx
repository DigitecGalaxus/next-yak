...
remove the JSX usage and import the file wherever the styles should take effect. Usually that is your
layout, but any module that ends up in the bundle works:
