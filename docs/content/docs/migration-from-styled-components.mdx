...
- Mixins
- Global styles (`createGlobalStyle` becomes [`globalCss`](/docs/features#global-styles))
...
[`globalCss`](/docs/features#global-styles) applies as soon as the file declaring it is imported, so
...
import { globalCss } from "next-yak"; // [!code ++]
