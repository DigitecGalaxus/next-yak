...
Optimizations are performed by the bundler's native CSS tool (PostCSS for Next.js with Webpack, Lightning CSS for Turbopack and Vite), allowing you to use its full potential.
...
See related documentation: [Migration from styled-components](/docs/migration-from-styled-components)
