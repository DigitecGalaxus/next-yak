...
Works with **Next.js** (Webpack & Turbopack), **[Vite 7+](/documentation/vite)** (react-router, tanstack start, and more), and **[Storybook](/documentation/storybook)**.
...
You're now ready to use next-yak in your project and if you need to migrate from styled-components, you can follow the [migration guide](/documentation/migration-from-styled-components).
...
Since v9.1.0, next-yak supports Vite 7+ (including Vite 8 with OXC/Rolldown). Check out the [Vite guide](/documentation/vite) for more setup instructions.

## Using with Storybook

The addon `storybook-addon-yak` enables next-yak in Storybook 10+ with both Vite and Webpack builders. See the [Storybook guide](/documentation/storybook) for details.
