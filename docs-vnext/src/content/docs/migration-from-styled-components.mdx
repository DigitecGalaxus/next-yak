...
For more detailed information, refer to the [FAQ](/documentation/faq#i-get-an-error-about-selector-that-are-not-pure).
...
<Callout type="warn">
  **Deprecation Notice**: The `:global()` selector syntax is deprecated and will be removed in the
  ...
  [Migration to native CSS](/documentation/migration-to-native-css).
</Callout>
