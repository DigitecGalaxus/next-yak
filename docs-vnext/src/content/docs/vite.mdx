...
next-yak has first-class Vite support via the `viteYak` plugin and any Vite-based framework works out of the box.
...
[Migration from styled-components](/documentation/migration-from-styled-components) guide.
