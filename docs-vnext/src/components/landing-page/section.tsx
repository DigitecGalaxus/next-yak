...
/**
 * Even `<section>` siblings get the raised tone and wave edges. The hero wrapper in
 * page.tsx holds two sections, so keep that count even or the alternation flips.
 */
...
export const Container = styled.div`
  ...
  /* fluid, since a breakpoint jump would fight the @container queries inside */
...
const Outer = styled.section`
  ...
  /* Leave the wave strips unpainted so the pinned hero shows above the curve. The
     clip is 1px short of the 38px strip so the layers overlap without a hairline seam. */
...
// Fills below the curve to the strip's bottom edge (29.86 = 38px / the 1.2727 scale).
const FILL_PATH =
