/**
 * IMPORTANT: This file contains the internal implementation of @yak/qwik's core APIs.
 *
 * Purpose:
 * - Provides the actual runtime implementations for styled, css, keyframes, etc.
 * - Referenced only by the compiled code "@yak/qwik/internal"
 *
 * Usage:
 * - DO NOT import from this file directly in your application code.
 * - Always use `import { ... } from "@yak/qwik"` in your source files.
 ...
 * 4. Makes @yak/qwik work out-of-the-box with testing frameworks like Jest and Vitest
 *
