/**
 * This file contains the typings for the public API for @yak/qwik and testing mocks
 *
 ...
 *
 * Purpose:
 * 1. Provide a test-friendly version of the @yak/qwik API
 * 2. Offer type definitions for the public API
 *
 * Usage in tests:
 * - Import from "@yak/qwik" as usual in your test files
 ...
 *   (e.g. via `yak` from "@yak/qwik/vite")
 *
 * For maintainers:
 * - Keep this API surface in sync with the actual implementation in @yak/qwik/internal
...
// "@yak/qwik/context/baseContext" to the user's theme context file
export { useTheme, YakThemeContext } from "@yak/qwik/context";
