...
import "data:text/css;base64,QGtleWZyYW1lcyBzd2VlcF9tN3VCQnUgewogIGZyb20gewogICAgYmFja2dyb3VuZC1wb3NpdGlvbjogLTYwMHB4IDA7CiAgfQogIHRvIHsKICAgIGJhY2tncm91bmQtcG9zaXRpb246IDYwMHB4IDA7CiAgfQp9";
const sweep = /*YAK Extracted CSS:
@keyframes sweep_m7uBBu {
  from {
...
animation: sweep_m7uBBu 2s infinite linear;
@yak-branch b0 {
