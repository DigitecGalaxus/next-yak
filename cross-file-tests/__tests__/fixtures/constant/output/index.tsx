...
export var Button = /*YAK EXPORTED STYLED:Button:index_Button_Qfpjpd*//*YAK Extracted CSS:
:global(.index_Button_Qfpjpd) {
  color: red;
...
*/ /*#__PURE__*/ Object.assign(/*#__PURE__*/ __yak.__yak_button("index_Button_Qfpjpd", function(param) {
    var $variant = param.$variant;
    return $variant === "secondary" && /*#__PURE__*/ css("index_Button___Qfpjpd");
}), {
    "displayName": "Button"
});